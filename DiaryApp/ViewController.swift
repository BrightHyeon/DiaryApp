...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(
            ...
            name: NSNotification.Name("editDiary"),             //from "WriteDiaryViewController"
            object: nil
        )
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(starDiaryNotification(_:)),
            name: NSNotification.Name("starDiary"),             //from "DiaryDetailViewController"
            object: nil
        )
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(deleteDiaryNotification(_:)),
            name: NSNotification.Name("deleteDiary"),           //from "DiaryDetailViewController"
            object: nil
        )
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {     //connect with "WriteDiaryViewController"
...
//MARK: - Extension
extension ViewController: WriteDiaryViewDelegate {              //new case diary
...
extension ViewController: UICollectionViewDelegate {                //connect with "DiaryDetailViewController"
